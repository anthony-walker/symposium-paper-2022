...
\revised{We tested the scheme using constant-pressure and constant-volume ideal-gas reactor simulations, showing speedup in performance from a factor of 3 up to nearly 4000 times for chemical kinetic models with 55 to 7171 species, in comparison with typical dense solvers.
The method also improves performance by a factor of 1.06 to 21.1, for models larger than 200 species, in comparison with a fully exact, analytical Jacobian used as the preconditioner.}{revOne}
